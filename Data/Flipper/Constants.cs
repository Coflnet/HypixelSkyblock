...
namespace Coflnet.Sky.Core
{
    public class Constants
    {
        ...
        public readonly static HashSet<ItemReferences.Reforge> RelevantReforges = new HashSet<ItemReferences.Reforge>()
        {
            ...
            ItemReferences.Reforge.lustrous,
        ...
        */
        ...
        public static bool DoesRecombMatter(Category category, string tag)
        {
            if (category == Category.WEAPON || category == Category.ARMOR || category == Category.ACCESSORIES
                ...
                return true;
            string[] endings = ["CLOAK", "NECKLACE", "BELT", "GLOVES", "BRACELET", "HOE", "PICKAXE", "GAUNTLET", "WAND", "ROD", "DRILL", "INFINI_VACUUM", "POWER_ORB", "GRIFFIN_UPGRADE_STONE_EPIC"];
        ...
        public static Dictionary<string, string> ShardNames = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "Leviathan", "LEVIATHAN" },
            { "Hideonring", "HIDEONRING" },
            { "Falcon", "FALCON" },
            { "Komodo Dragon", "KOMODO_DRAGON" },
            { "Stalagmight", "STALAGMIGHT" },
            { "Toucan", "TOUCAN" },
            { "Ghost", "GHOST" },
            { "Snowfin", "SNOWFIN" },
            { "Kiwi", "KIWI" },
            { "Hideongift", "HIDEONGIFT" },
            { "Quake", "QUAKE" },
            { "Magma Slug", "MAGMA_SLUG" },
            { "Wither", "WITHER" },
            { "Zealot", "ZEALOT" },
            { "Kraken", "KRAKEN" },
            { "Bramble", "BRAMBLE" },
            { "Cavernshade", "CAVERNSHADE" },
            { "Rana", "RANA" },
            { "Taurus", "TAURUS" },
            { "Apex Dragon", "APEX_DRAGON" },
            { "Beaconmite", "BEACONMITE" },
            { "Miner Zombie", "MINER_ZOMBIE" },
            { "Goldfin", "GOLDFIN" },
            { "Tadgang", "TADGANG" },
            { "Zombie Soldier", "ZOMBIE_SOLDIER" },
            { "Sylvan", "SYLVAN" },
            { "Joydive", "JOYDIVE" },
            { "Starborn", "STARBORN" },
            { "Molthorn", "MOLTHORN" },
            { "Pandarai", "PANDARAI" },
            { "Lapis Skeleton", "LAPIS_SKELETON" },
            { "Tank Zombie", "TANK_ZOMBIE" },
            { "Terra", "TERRA" },
            ...
            { "Seagull", "SEAGULL" },
            { "Sycophant", "SYCOPHANT" },
            { "Lord Jawbus", "LORD_JAWBUS" },
            { "Xyz", "XYZ" },
            { "Cod", "COD" },
            { "Bogged", "SEA_ARCHER" },
            { "Cropeetle", "CROPEETLE" },
            { "Inferno Koi", "INFERNO_KOI" },
            { "Daemon", "DAEMON" },
            { "Birries", "BIRRIES" },
            { "Abyssal Lantern", "ABYSSAL_LANTERN" },
            { "Strider Surfer", "STRIDER_SURFER" },
            { "Tenebris", "TENEBRIS" },
            { "Bullfrog", "BULLFROG" },
            { "Invisibug", "INVISIBUG" },
            { "Cryo", "CRYO" },
            ...
            { "Cuboa", "CUBOA" },
            { "Crocodile", "CROCODILE" },
            { "Power Dragon", "POWER_DRAGON" },
            { "Dragonfly", "DRAGONFLY" },
            { "Sun Fish", "SUN_FISH" },
            { "Hideongeon", "HIDEONGEON" },
            { "Newt", "NEWT" },
            { "Leatherback", "LEATHERBACK" },
            { "Lunar Moth", "LUNAR_MOTH" },
            { "Piranha", "PIRANHA" },
            { "Dreadwing", "DREADWING" },
            { "Water Hydra", "WATER_HYDRA" },
            { "Cinderbat", "CINDER_BAT" },
            { "Hideoncave", "HIDEONCAVE" },
            { "Quartzfang", "QUARTZFANG" },
            { "Coralot", "CORALOT" },
            { "Bolt", "BOLT" },
            { "Chill", "CHILL" },
            { "Crow", "CROW" },
            ...
            { "Chameleon", "CHAMELEON" },
            { "Lizard King", "LIZARD_KING" },
            { "Lumisquid", "LUMISQUID" },
            { "Star Sentry", "STAR_SENTRY" },
            { "Shellwise", "SHELLWISE" },
            { "Mist", "MIST" },
            { "Mimic", "MIMIC" },
            ...
            { "Moray Eel", "MORAY_EEL" },
            { "Flash", "FLASH" },
            { "Loch Emperor", "SEA_EMPEROR" },
            { "Kada Knight", "KADA_KNIGHT" },
            { "Glacite Walker", "GLACITE_WALKER" },
            { "Matcho", "MATCHO" },
            { "Rain Slime", "RAIN_SLIME" },
            { "Wyvern", "WYVERN" },
            { "Barbarian Duke X", "BARBARIAN_DUKE_X" },
            { "Hideonsack", "HIDEONSACK" },
            { "Hideonbox", "HIDEONBOX" },
            { "Fenlord", "FENLORD" },
            { "Eel", "EEL" },
            { "Blizzard", "BLIZZARD" },
            ...
            { "Gecko", "GECKO" },
            { "Wartybug", "WARTYBUG" },
            { "Night Squid", "NIGHT_SQUID" },
            { "Tempest", "TEMPEST" },
            { "Golden Ghoul", "GOLDEN_GHOUL" },
            { "Boreal Owl", "BOREAL_OWL" },
            { "Troglobyte", "TROGLOBYTE" },
            { "Prince", "PRINCE" },
            { "Wither Specter", "WITHER_SPECTER" },
            { "Tiamat", "TIAMAT" },
            { "Obsidian Defender", "OBSIDIAN_DEFENDER" },
            { "Lava Flame", "LAVA_FLAME" },
            { "Pest", "PEST" },
            { "Bitbug", "BITBUG" },
            { "Dodo", "DODO" },
            { "Bal", "BAL" },
            ...
            // 0.27 shards
            { "Abyssal Miner", "ABYSSAL_MINER" },
            { "Ant", "ANT" },
            { "Anteater", "ANTEATER" },
            { "Areita", "AREITA" },
            { "Badger", "BADGER" },
            { "Bayou Sludge", "BAYOU_SLUDGE" },
            { "Beeheemoth", "BEEHEEMOTH" },
            { "Beetle", "CROPEETLE" },
            { "Billygoat", "BILLYGOAT" },
            ...
            { "Brineling", "BRINELING" },
            { "Bunbun", "BUNBUN" },
            { "Cavernfish", "CAVERNFISH" },
            { "Cheeky Tiki", "CHEEKY_TIKI" },
            { "Chuckwalla", "CHUCKWALLA" },
            { "Cricket", "CRICKET" },
            { "Dive Ghast", "DIVE_GHAST" },
            { "Doomspiral", "DOOMSPIRAL" },
            { "Driftling", "DRIFTLING" },
            { "Drybark", "DRYBARK" },
            { "Dumpster Diver", "DUMPSTER_DIVER" },
            ...
            { "Gazer", "GAZER" },
            { "Gemzie", "GEMZIE" },
            { "Ghost Crab", "GHOST_CRAB" },
            { "Giant Isopod", "GIANT_ISOPOD" },
            { "Giant Water Bug", "GIANT_WATER_BUG" },
            ...
            { "Hawk", "HAWK" },
            { "Hewver", "HEWVER" },
            { "Hideonfloor", "HIDEONFLOOR" },
            { "Hideonsun", "HIDEONSUN" },
            { "Hideonwall", "HIDEONWALL" },
            { "Hideyho", "HIDEYHO" },
            { "Hivethief", "HIVETHIEF" },
            ...
            { "June Bug", "JUNE_BUG" },
            { "Keeled Slug", "KEELED_SLUG" },
            { "Lava Leech", "LAVA_LEECH" },
            { "Litterbug", "LITTERBUG" },
            { "Locust", "LOCUST" },
            { "Macaw", "MACAW" },
            { "Maggot", "MAGGOT" },
            { "Mantis Shrimp", "MANTIS_SHRIMP" },
            { "Minos Hunter", "MINOS_HUNTER" },
            { "Mite", "MITE" },
            { "Mosquito", "MOSQUITO" },
            { "Moth", "MOTH" },
            ...
            { "Parched", "PARCHED" },
            { "Polaris", "POLARIS" },
            { "Pollendart", "POLLENDART" },
            { "Primordial", "PRIMORDIAL" },
            { "Puck", "PUCK" },
            { "Queen Ant", "QUEEN_ANT" },
            { "Queen Bee", "QUEEN_BEE" },
            { "Queen Snake", "QUEEN_SNAKE" },
            { "Rabbit Cat", "RABBIT_CAT" },
            { "Rabbit Godfather", "RABBIT_GODFATHER" },
            { "Rabbit Godmother", "RABBIT_GODMOTHER" },
            { "Rabbit Mafioso", "RABBIT_MAFIOSO" },
            { "Rabbit Neighbor", "RABBIT_NEIGHBOR" },
            { "Rat", "RAT" },
            { "Red Panda", "RED_PANDA" },
            { "Rockmite", "ROCKMITE" },
            { "Scatha", "SCATHA" },
            ...
            { "Sea Witch", "SEA_WITCH" },
            { "Sepialot", "SEPIALOT" },
            { "Shrieky Tiki", "SHRIEKY_TIKI" },
            { "Shuddersquid", "SHUDDERSQUID" },
            { "Shyworm", "SHYWORM" },
            { "Silkbreeze", "SILKBREEZE" },
            { "Sneaky Tiki", "SNEAKY_TIKI" },
            { "Snoozle", "SNOOZLE" },
            { "Solar", "SOLAR" },
            { "Solsnatcher", "SOLSNATCHER" },
            { "Special Zealot", "SPECIAL_ZEALOT" },
            { "Sprawl", "SPRAWL" },
            { "Stag Beetle", "STAG_BEETLE" },
            { "Stingray", "STINGRAY" },
            { "Stoneworm", "STONEWORM" },
            { "Stridersurfer", "STRIDER_SURFER" },
            { "Strongarm", "STRONGARM" },
            { "Tepid", "TEPID" },
            { "Thunder", "THUNDER" },
            { "Timestalk Clone", "TIMESTALK_CLONE" },
            { "Timil", "TIMIL" },
            { "Torrid", "TORRID" },
            ...
            { "Troodon", "TROODON" },
            { "Vulture", "VULTURE" },
            { "Water Snake", "WATER_SNAKE" },
            { "Wetwing", "WETWING" },
            { "Wiki Tiki", "WIKI_TIKI" },
            { "Wild Hog", "WILD_HOG" },
            { "Wither Spectre", "WITHER_SPECTER" },
            { "Wolverine", "WOLVERINE" },
            { "Woodchucker", "WOODCHUCKER" },
            { "Woodlouse", "WOODLOUSE" },
            { "Woodpecker", "WOODPECKER" },
            { "Wumpa", "WUMPA" },
            { "Zealot Bruiser", "BRUISER" },
            { "Zombuddy", "ZOMBUDDY" },
        };
    }
}
